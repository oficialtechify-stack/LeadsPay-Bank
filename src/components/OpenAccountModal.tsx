  ...
  useEffect(() => {
    ...
    if (currentUserId) {
      ...
      if (local) {
        ...
        // Pre-fill fields if in revision
  ...
  const handleGooglePreFill = async () => {
    try {
      ...
      if (authErr?.code !== 'auth/popup-closed-by-user') {
        console.warn('Google prefill warning:', err);
      }
    }
  };
      ...
      >
              ...
              <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3">
                ...
                <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-center">
                  <p className="text-xs text-amber-300">
                    O administrador <span className="font-mono text-white">rickmarketing81@gmail.com</span> já recebeu seus dados para análise.
                  </p>
                </div>
            ...
            <div className="flex items-center gap-2.5 mb-4 shrink-0">
              ...
              <div className="flex-1 pr-6">
                ...
                <p className="text-xs text-slate-400">
                  ...
                  {step === 4 && 'Revise as informações e envie para aprovação do admin'}
                </p>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto pr-1 space-y-4 text-left">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="p-3 rounded-2xl bg-white/[0.03] border border-white/10 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <span className="text-xs font-semibold text-white block">Preencher rápido com o Google</span>
                        <span className="text-[10px] text-slate-400">Puxa seu nome e e-mail com 1 clique</span>
                      </div>
                    </div>
                    <button
                      type="button"
                      ...
                      className="px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/15 text-white text-xs font-semibold transition-all shrink-0 cursor-pointer flex items-center gap-1.5"
                    >
                      {isGoogleLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Sparkles className="w-3.5 h-3.5 text-[#00e676]" />}
                      <span>Vincular</span>
                    </button>
                  </div>
              ...
              {step === 4 && (
                <div className="space-y-4">
                  ...
                  <div className="p-3 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-xs text-amber-300 flex items-center gap-2.5">
                    <ShieldCheck className="w-5 h-5 shrink-0 text-amber-400" />
                    <span>
                      Sua proposta será enviada diretamente para a central do administrador (<span className="font-mono text-white">rickmarketing81@gmail.com</span>) para validação.
                    </span>
                  </div>
                </div>
              )}
        ...
        {isSubmittedSuccess && (
          <div className="py-8 text-center space-y-4 my-auto">
            ...
            <div className="p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 max-w-sm mx-auto text-left space-y-1 text-xs">
              <span className="text-slate-400 block text-[11px]">Responsável pela aprovação:</span>
              <span className="font-mono text-[#00e676] font-semibold block">rickmarketing81@gmail.com</span>
              <p className="text-[11px] text-slate-400 pt-1">
                Você será notificado assim que o administrador analisar sua documentação.
              </p>
            </div>
